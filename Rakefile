...
Jeweler::Tasks.new do |gem|
  ...
  gem.description = %Q{Glimmer DSL for Tk (MRI Ruby Desktop Development GUI Library)}
  gem.email = "andy.am@gmail.com"
  gem.authors = ["AndyMaleh"]
  gem.executables = ['girb']
  gem.files = ['README.md', 'CHANGELOG.md', 'VERSION', 'LICENSE.txt', 'glimmer-dsl-tk.gemspec', 'bin/**/*', 'lib/**/*', 'icons/**/*', 'samples/**/*']
